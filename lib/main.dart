...
class _SIFormState extends State<SIForm> {
  ...
  var _currencies = ["KES", "Rupees", "JPY", "Pound", "Dollars"];
  ...
  void initState() {
    super.initState();
    currentSelectedValue = _currencies[0];
  }
                      ...
                      Expanded(
                        child: DropdownButton<String>(
                            ...
                            onChanged: (String newValueSelected) {
                              _changeValueSelected(newValueSelected);
                            }),
                      ),
                    ],
                  ),
  ...
  void _changeValueSelected(String newValueSelected) {
    setState(() {
      this.currentSelectedValue = newValueSelected;
    });
  }
